    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
     ...
     new ChatThread { ChatThread_Id = new Guid("eeeeeeee-eeee-eeee-eeee-000000000020"), Listing_Id = new Guid("cccccccc-cccc-cccc-cccc-000000000015"), Buyer_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000002", Seller_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000001", CreatedAt = new DateTime(2023, 1, 20, 0, 0, 0, DateTimeKind.Utc) }
            ...
            builder.Entity<Report>().HasData(
                ...
                new Report { Report_Id = new Guid("11111111-1111-1111-1111-000000000002"), Reporter_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000003", ReportedUser_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000001", TargetType = ReportTargetType.User, Reason = "Intento de estafa", Comment = "Me pidió hacer la transferencia fuera de la plataforma.", CreatedAt = new DateTime(2023, 1, 14, 11, 30, 0, DateTimeKind.Utc) },
                ...
                new Report { Report_Id = new Guid("11111111-1111-1111-1111-000000000005"), Reporter_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000001", ReportedUser_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000002", TargetType = ReportTargetType.User, Reason = "Comportamiento inapropiado", Comment = "Envió mensajes ofensivos durante la negociación del precio.", CreatedAt = new DateTime(2023, 1, 20, 8, 45, 0, DateTimeKind.Utc) },
                ...
                new Report { Report_Id = new Guid("11111111-1111-1111-1111-000000000009"), Reporter_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000002", ReportedUser_Id = "aaaaaaaa-aaaa-aaaa-aaaa-000000000003", TargetType = ReportTargetType.User, Reason = "Cuenta sospechosa", Comment = "El perfil parece ser un bot, respuestas automáticas y rápidas.", CreatedAt = new DateTime(2023, 1, 29, 9, 30, 0, DateTimeKind.Utc) },
