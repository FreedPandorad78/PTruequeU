    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ListingImage_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Listing_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListingImages", x => x.ListingImage_Id);
                    table.ForeignKey(
                        name: "FK_ListingImages_Listings_Listing_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ListingImages_Listing_Id",
                table: "ListingImages",
                column: "Listing_Id");
